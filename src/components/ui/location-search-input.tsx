    ...
    return (
        ...
        >
            ...
            <input
                ...
                className="w-full bg-transparent font-brand-text text-[length:var(--wm-size-16)] text-[color:var(--wm-color-input-text)] outline-none placeholder:text-[color:var(--text-secondary)]"
            />
        </label>
    )
}
